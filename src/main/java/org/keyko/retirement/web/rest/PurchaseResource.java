...
/**
 * REST controller for managing {@link org.keyko.retirement.domain.Purchase}.
 */
@RestController
@RequestMapping("/api")
@Transactional
            ...
            .map(
                existingPurchase -> {
                    ...
                    if (purchase.getCurrency() != null) {
                        existingPurchase.setCurrency(purchase.getCurrency());
                    }
                    if (purchase.getNumber() != null) {
                        existingPurchase.setNumber(purchase.getNumber());
                    }
                    if (purchase.getComission() != null) {
                        existingPurchase.setComission(purchase.getComission());
                    }
